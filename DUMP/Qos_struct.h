...
struct FQosSubspaceComparisonParams {
	int32_t MaxNonSubspacePingMs; // 0x00(0x04)
	int32_t MinSubspacePingMs; // 0x04(0x04)
	int32_t ConstantMaxToleranceMs; // 0x08(0x04)
	float ScaledMaxTolerancePct; // 0x0c(0x04)
};
...
struct FQosRegionInfo {
	...
	bool bAllowSubspaceBias; // 0x2b(0x01)
...
struct FRegionQosInstance {
	struct FQosRegionInfo Definition; // 0x00(0x40)
