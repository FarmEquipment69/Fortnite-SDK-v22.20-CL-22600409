...
struct FARPlaneUpdatePayload {
	...
	enum class EARObjectClassification ObjectClassification; // 0xc0(0x01)
...
struct FARImageUpdatePayload {
	...
	char pad_18[0x8]; // 0x18(0x08)
	struct FTransform WorldTransform; // 0x20(0x60)
	struct UARCandidateImage* DetectedImage; // 0x80(0x08)
...
struct FARPoseUpdatePayload {
	struct FTransform WorldTransform; // 0x00(0x60)
...
struct FARMeshUpdatePayload {
	...
	char pad_18[0x8]; // 0x18(0x08)
	struct FTransform WorldTransform; // 0x20(0x60)
	enum class EARObjectClassification ObjectClassification; // 0x80(0x01)
...
struct FARGeoAnchorUpdatePayload {
	...
	char pad_18[0x8]; // 0x18(0x08)
	struct FTransform WorldTransform; // 0x20(0x60)
	float Longitude; // 0x80(0x04)
	float Latitude; // 0x84(0x04)
	float AltitudeMeters; // 0x88(0x04)
	enum class EARAltitudeSource AltitudeSource; // 0x8c(0x01)
...
struct FARTraceResult {
	...
	struct UARTrackedGeometry* TrackedGeometry; // 0x70(0x08)
...
struct FARCameraIntrinsics {
	...
	struct FVector2D FocalLength; // 0x08(0x10)
	struct FVector2D PrincipalPoint; // 0x18(0x10)
};
