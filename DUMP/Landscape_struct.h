...
struct FGrassVariety {
	...
	struct TArray<struct UMaterialInterface*> NaniteOverrideMaterials; // 0x18(0x10)
	struct FPerPlatformFloat GrassDensity; // 0x28(0x04)
	bool bUseGrid; // 0x2c(0x01)
	char pad_2D[0x3]; // 0x2d(0x03)
	float PlacementJitter; // 0x30(0x04)
	struct FPerPlatformInt StartCullDistance; // 0x34(0x04)
	struct FPerPlatformInt EndCullDistance; // 0x38(0x04)
	int32_t MinLOD; // 0x3c(0x04)
	enum class EGrassScaling Scaling; // 0x40(0x01)
	char pad_41[0x3]; // 0x41(0x03)
	struct FFloatInterval ScaleX; // 0x44(0x08)
	struct FFloatInterval ScaleY; // 0x4c(0x08)
	struct FFloatInterval ScaleZ; // 0x54(0x08)
	bool RandomRotation; // 0x5c(0x01)
	bool AlignToSurface; // 0x5d(0x01)
	bool bUseLandscapeLightmap; // 0x5e(0x01)
	struct FLightingChannels LightingChannels; // 0x5f(0x01)
	bool bReceivesDecals; // 0x60(0x01)
	bool bCastDynamicShadow; // 0x61(0x01)
	bool bCastContactShadow; // 0x62(0x01)
	bool bKeepInstanceBufferCPUCopy; // 0x63(0x01)
