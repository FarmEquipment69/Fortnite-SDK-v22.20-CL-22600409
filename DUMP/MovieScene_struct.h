...
struct FMovieSceneSequencePlaybackSettings {
	...
	struct FMovieSceneSequenceTickInterval TickInterval; // 0x08(0x08)
	float PlayRate; // 0x10(0x04)
	float StartTime; // 0x14(0x04)
	char bRandomStartTime : 1; // 0x18(0x01)
	char bRestoreState : 1; // 0x18(0x01)
	char bDisableMovementInput : 1; // 0x18(0x01)
	char bDisableLookAtInput : 1; // 0x18(0x01)
	char bHidePlayer : 1; // 0x18(0x01)
	char bHideHUD : 1; // 0x18(0x01)
	char bDisableCameraCuts : 1; // 0x18(0x01)
	char bPauseAtEnd : 1; // 0x18(0x01)
	char bInheritTickIntervalFromOwner : 1; // 0x19(0x01)
...
struct FMovieSceneSequenceTickInterval {
	...
	bool bTickWhenPaused; // 0x04(0x01)
	bool bAllowRounding; // 0x05(0x01)
