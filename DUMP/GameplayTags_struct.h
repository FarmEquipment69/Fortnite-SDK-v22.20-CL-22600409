...
struct FGameplayTag {
	struct FName TagName; // 0x00(0x04)
};
...
struct FGameplayTagRedirect {
	struct FName OldTagName; // 0x00(0x04)
	struct FName NewTagName; // 0x04(0x04)
};
...
struct FGameplayTagSource {
	struct FName SourceName; // 0x00(0x04)
	enum class EGameplayTagSourceType SourceType; // 0x04(0x01)
	char pad_5[0x3]; // 0x05(0x03)
	struct UGameplayTagsList* SourceTagList; // 0x08(0x08)
	struct URestrictedGameplayTagsList* SourceRestrictedTagList; // 0x10(0x08)
};
